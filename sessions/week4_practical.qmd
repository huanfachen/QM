...
![]({{< var module.web >}}/L4_images/bike_factory.jpg){width="600"} 
...
We have: $$x_1=11$$, $$x_2=0$$. and $$x_3=30$$. 
...
*Note:* be careful here that you don't reassign variables!!

## Conclusions 

Here we solved a set of linear equations using algebra. Solving sets of linear equations is closely related to regression, a topic we will learn about in week 6. 

## Extension 

If you have time you can explore implementing an [ordinary least squares regression](https://www.geeksforgeeks.org/data-science/ordinary-least-squares-ols-using-statsmodels/). 
...
Choose one dependent variable ("aluminium_used", "rubber_used" or "paint_used"), and using the values for the number of items produced try to estimate the coefficients (the intercept and gradient). 

Essentially we are considering just one of our linear equations, and trying to find our coefficient values i.e. $M$. 

*Hint:* You might want to use `statsmodels` OLS package which you can read about [here](https://www.statsmodels.org/dev/generated/statsmodels.regression.linear_model.OLS.html). 
...
# define independent variables (productionacheived)
X = ??
...
# define independent variables (production acheived)
X = df[["x1_handlebars",	"x2_brakes",	"x3_wheels"]]
