...
# Kendall rank correlation (Kendall's $\tau$)
## Definition


## Key takeaways 

- Can use Pearson/Spearman/Kendall correlation to measure the relationship between two variables.
- Choose the correlation metric based on the dataset and interpret them correctly.
