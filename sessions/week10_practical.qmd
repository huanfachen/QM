...
inner_line_h = mlines.Line2D(
    [], [], color=colors_boundary["Inner London"], linestyle="--", linewidth=1.5,
    label="Inner London"
)
outer_line_h = mlines.Line2D(
    [], [], color=colors_boundary["Outer London"], linestyle="--", linewidth=1.5,
    label="Outer London"
)

handles_all_h = handles_h + [inner_line_h, outer_line_h]
labels_all_h = labels_h + ["Inner London", "Outer London"]

plt.legend(handles_all_h, labels_all_h,
           title="Hier. cluster",
