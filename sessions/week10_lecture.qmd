...
<div style="text-align:center;">
  <img src="L10_images/hierarchical_illustration_step1.png" alt="roseplot" style="max-width:80%;">
  <div style="font-size:0.8em; color: #555; margin-top:4px;">
  </div>
</div>
...
<div style="text-align:center;">
  <img src="L10_images/hierarchical_illustration_step2.png" alt="roseplot" style="max-width:80%;">
  <div style="font-size:0.8em; color: #555; margin-top:4px;">
  </div>
</div>
...
<div style="text-align:center;">
  <img src="L10_images/hierarchical_illustration_step3.png" alt="roseplot" style="max-width:80%;">
  <div style="font-size:0.8em; color: #555; margin-top:4px;">
  </div>
</div>
...
<div style="text-align:center;">
  <img src="L10_images/kmeans_cluster_centroid_roseplot.png" alt="roseplot" style="max-width:80%;">
  <div style="font-size:0.8em; color: #555; margin-top:4px;">
  </div>
</div>
...
## Mapping
<div style="text-align:center;">
  <img src="L10_images/kmeans_cluster_mapping.png" alt="elbow" style="max-width:80%;">
  <div style="font-size:0.8em; color: #555; margin-top:4px;">
...
| Range           | <span class="fragment">[0, $\infty$)</span>|
...
| Range           | <span class="fragment">(-$\infty$, $\infty$)</span>|
| Is it normalised (i.e. in [-1,1] or [0,1])           | <span class="fragment">No</span>|
...
<div style="text-align:center;">
  <img src="L3_images/t_tets_types.webp" alt="Types of T-tests" style="max-width:70%;">
  <div style="font-size:0.8em; color: #555; margin-top:4px;">
