...
- Sensitive to centroid initialisation, which can lead to poor solutions (solution: try different random initialisation and pick up the best one);
...
# Integrating clustering and spatial considerations
