...
- Two ways of hierarchical clustering
  ...
  - *divisive*: top-down; Begins with one big cluster and gradually split into smaller clusters 
...
## Mapping
<div style="text-align:center;">
  <img src="L10_images/mapping_school_clusters.png" alt="elbow" style="max-width:80%;">
  <div style="font-size:0.8em; color: #555; margin-top:4px;">
